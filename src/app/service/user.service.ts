...
export class UserService {
  ...
  memberLogin(logInfo: any): Observable<any> {
    return this.http.post<any>(API_URL + '/communityMember/login', logInfo, httpOptions)
      .pipe(
        catchError(this.handleError('communityMemberLogin', logInfo))
      )
  }
